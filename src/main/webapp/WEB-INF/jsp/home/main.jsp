...
<html>
	<head>
		<title>Intergrated Control Center</title>
		<meta charset="UTF-8" />
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<div class="logo">
							<span><img src="${pageContext.request.contextPath}/resource/images/logo.png"></span>
						</div>
						<div class="content">
							<div class="inner">
						...
						<nav>
							<ul>
								<li><a href="${pageContext.request.contextPath}/controltower/main.do">Control Tower</a></li>
					...
					<div id="main">
						...
						<!-- Intro -->
							<article id="intro">
								...
								<span class="image main"><img src="${pageContext.request.contextPath}/resource/images/pic01.jpg" alt="" /></span>
						...
						<!-- Work -->
							<article id="work">
								...
								<span class="image main"><img src="${pageContext.request.contextPath}/resource/images/pic02.jpg" alt="" /></span>
						...
						<!-- About -->
							<article id="about">
								...
								<span class="image main"><img src="${pageContext.request.contextPath}/resource/images/pic03.jpg" alt="" /></span>
